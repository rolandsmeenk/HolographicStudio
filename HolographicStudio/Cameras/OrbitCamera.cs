...
namespace HolographicStudio.Cameras
{
    /// <summary>
    /// Simple orbit camera that rotates around an fixed point
    /// </summary>
    public sealed class OrbitCamera : Camera
    {
        ...
        private void RecomputeEye()
        {
            ...
            var matrix = Matrix.RotationX(_upDown) * Matrix.RotationY(_rotation);
            var x = Vector3.Transform(-Vector3.UnitZ * Radius, matrix);
